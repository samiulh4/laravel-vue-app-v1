            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-4">
                    <div class="input-group">
                        ...
                        <input type="text" name="phone_no" id="phone_no" class="form-control " placeholder="Enter Phone No" />
                ...
                <div class="col-md-6 mt-4">
                    <div class="input-group">
                        ...
                        <input type="text" name="date_of_birth" id="date_of_birth" class="form-control dob-datepicker" placeholder="" />
                ...
                <div class="col-md-6 mt-4">
                    <div class="input-group">
                        ...
                        <input type="text" name="national_id" id="passport_no" class="form-control " placeholder="Enter Passport No" />
            ...
            <div class="row">
                <div class="col-md-6 mt-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="file" name="picture" id="picture" onchange="imageUploadWithCroppingAndDetect(this, 'preview_picture', 'user_pic_base64')" />
                ...
                <div class="col-md-6 mt-3">
                    <figure>
                        <img src="{{ asset('assets/img/default.png') }}" class="img-thumbnail" alt="Profile Picture" width="200" height="200" id="preview_picture" />
                    </figure>
