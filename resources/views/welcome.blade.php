...
<head>
    ...
    <link rel="apple-touch-icon" sizes="144x144"
          href="{{ asset('assets/newshub/images/ico/apple-touch-icon-144-precomposed.png') }}">
    <link rel="apple-touch-icon" sizes="114x114"
          href="{{ asset('assets/newshub/images/ico/apple-touch-icon-114-precomposed.png') }}">
    <link rel="apple-touch-icon" sizes="72x72"
          href="{{ asset('assets/newshub/images/ico/apple-touch-icon-72-precomposed.html') }}">
    <link rel="apple-touch-icon" sizes="57x57"
          href="{{ asset('assets/newshub/images/ico/apple-touch-icon-57-precomposed.png') }}">
...
<div class="main-wrapper tr-page-top">
    <div class="container-fluid">
        <div class="tr-topbar clearfix margin-bottom-0">
            <div class="row">
                <div class="col-lg-3">
                    <a class="navbar-brand d-none d-lg-block" href="index-2.html"><img class="img-fluid"
                                                                                       src="{{ asset('assets/newshub/images/logo.png') }}"
                                                                                       alt="Logo"></a>
                </div>
                <div class="col-lg-9">
                        ...
                        <div class="user">
                            <div class="user-image">
                                <img class="img-fluid img-circle"
                                     src="{{ asset('assets/newshub/images/others/user.png') }}" alt="Image">
                            </div>
                            <div class="dropdown user-dropdown">
                                Hello,
                                <a href="#" aria-expanded="true">Jhon Player<i class="fa fa-caret-down"
                        ...
                        <div class="searchNlogin">
                            <ul>
                                ...
                                <li class="dropdown language-dropdown">
                                    <a href="#" aria-expanded="true"><span class="change-text">En</span> <i
        ...
        <div class="tr-menu menu-responsive">
            <nav class="navbar navbar-default navbar-expand-lg">
                ...
                <a class="navbar-brand d-lg-none" href="index-2.html"><img class="img-fluid"
                                                                           src="{{ asset('assets/newshub/images/logo.png') }}"
                                                                           alt="Logo"></a>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="service">
                                <div class="service-icon">
                                    <img src="{{ asset('assets/newshub/images/service/1.png') }}" alt="Image"
                                         class="img-fluid">
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="service">
                                <div class="service-icon">
                                    <img src="{{ asset('assets/newshub/images/service/2.png') }}" alt="Image"
                                         class="img-fluid">
                                </div>
                                <h2>E-Commerce</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                        ...
                        <div class="col-md-4">
                            <div class="service">
                                <div class="service-icon">
                                    <img src="{{ asset('assets/newshub/images/service/3.png') }}" alt="Image"
                                         class="img-fluid">
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="service">
                                <div class="service-icon">
                                    <img src="{{ asset('assets/newshub/images/service/4.png') }}" alt="Image"
                                         class="img-fluid">
                                </div>
                                <h2>Adv. & PR</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                        ...
                        <div class="col-md-4">
                            <div class="service">
                                <div class="service-icon">
                                    <img src="{{ asset('assets/newshub/images/service/5.png') }}" alt="Image"
                                         class="img-fluid">
                                </div>
                                <h2>development</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                        ...
                        <div class="col-md-4">
                            <div class="service">
                                <div class="service-icon">
                                    <img src="{{ asset('assets/newshub/images/service/6.png') }}" alt="Image"
                                         class="img-fluid">
                                </div>
                                <h2>strategy</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
        ...
        <div class="tr-team-section text-center tr-section tr-section-padding">
            ...
            <ul class="team-members">
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/1.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/2.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/3.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/4.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/5.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/6.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/7.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/8.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                ...
                <li>
                    <div class="team-member">
                        <div class="team-member-image">
                            <img src="{{ asset('assets/newshub/images/team/9.jpg') }}" alt="Team Member"
                                 class="img-fluid">
                            <div class="team-social">
                                <ul class="social">
                                    <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
        ...
        <div class="container">
            <div class="footer-bottom-content">
                <div class="footer-logo">
                    <a href="index-2.html"><img class="img-fluid"
                                                src="{{ asset('assets/newshub/images/footer-logo.png') }}"
                                                alt="Logo"></a>
                </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                ...
                <address>
                    <p>&copy; 2017 <a href="#">Newshub</a>. Email: <a href="#"><span class="__cf_email__"
                                                                                     data-cfemail="e78e898188a7898290948f9285c984888a">[email&#160;protected]</span></a>
...
<script src="{{ asset('assets/newshub/cdn-cgi/scripts/rocket-loader.min.js') }}"
        data-cf-settings="81b4d21024b0c34dec3e798a-|49" defer=""></script>
</body>
